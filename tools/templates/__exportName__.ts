import { CodegenClient as __exportName__Service } from './internal/__namespace__-__serviceName__';
...
export { CodegenClient as __exportName__Service } from './internal/__namespace__-__serviceName__';

export const __exportName__ = async (options: ConnectOptions): Promise<__exportName__Service> => {
    ...
    return methodsMeta.reduce(
        codegenClientReducer<__exportName__Service>(
            connection,
            options.metadata,
            namespace,
            context
        ),
        {} as __exportName__Service
    );
};
